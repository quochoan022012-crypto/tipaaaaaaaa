...
typedef struct {
    ...
    CGMutablePathRef boxBotHiddenPath;
    CGMutablePathRef boxPlayerHiddenPath;
    // ==============================================
    ...
    // ===== THÊM MỚI: Dirty flag cho box bị che khuất =====
    bool boxBotHiddenDirty;
    bool boxPlayerHiddenDirty;
    // =====================================================
