...
void RenderESPForPawn(
    ...
    bool isVisible          // << THÊM THAM SỐ MỚI
) {
    ...
    if (isBox) {
        ...
        if(box == 0){
            ...
            if(isKnocked) { 
                ...
                // ===== THAY ĐỔI: Nếu visible dùng path xanh, không thì path đỏ =====
                if (isVisible) {
                    ESPAddFullRect(buffers->boxBotPath, x, y, boxWidth, boxHeight);
                    buffers->boxBotDirty = true;
                } else {
                    ESPAddFullRect(buffers->boxBotHiddenPath, x, y, boxWidth, boxHeight);
                    buffers->boxBotHiddenDirty = true;
                }
                // =================================================================
                ...
                if (isVisible) {
                    ...
                    ESPAddFullRect(buffers->boxPlayerHiddenPath, x, y, boxWidth, boxHeight);
                    buffers->boxPlayerHiddenDirty = true;
                }
                // =================================================================
            }
        } else if (box == 1){
            ...
            if(isKnocked) { 
                ...
                if (isVisible) {
                    ...
                    ESPAddCornerBox(buffers->boxBotHiddenPath, x, y, boxWidth, boxHeight);
                    buffers->boxBotHiddenDirty = true;
                }
                // =================================================================
                ...
                if (isVisible) {
                    ...
                    ESPAddCornerBox(buffers->boxPlayerHiddenPath, x, y, boxWidth, boxHeight);
                    buffers->boxPlayerHiddenDirty = true;
                }
                // =================================================================
            }
